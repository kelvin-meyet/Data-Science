...
# --> split text or pages into docs(chunk) function
...
def main():
    ...
    st.write("Admin Site for LLM Demo")
    ...
    if uploaded_file is not None:
        ...
        ## Split Text
        splitted_docs = split_text(pages, 1000, 200)  # 1000 chunks with 200 overlaps
        ...
        st.write("Creating the Vector Store with Faiss")
